...
class ChatWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.init_ui()
        self.worker = None
        self.timer = None  # 确保 timer 是实例变量

        # 存储内容
        self.worker_active = False
        self.thinking_widget = None  # 存储思考控件
    ...
    def init_ui(self):
        ...
        subtitle_label.setStyleSheet("color: #2C3E50; margin-bottom: 20px;")
        main_layout.addWidget(subtitle_label)

        # 添加搜索工具栏（在标题下方）
        self.search_toolbar = QWidget()
        self.search_toolbar.setFixedHeight(60)  # 增加高度
