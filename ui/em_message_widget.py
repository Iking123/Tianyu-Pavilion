...
from PyQt5.QtWebEngineWidgets import QWebEngineView  # 替换为 WebEngineView
...
class MessageWidget(QWidget):
    ...
    def __init__(self, role, content, is_thinking=False, parent=None):
        ...
        self.content_view.setContextMenuPolicy(Qt.NoContextMenu)  # 禁用右键菜单
        self.content_view.page().setBackgroundColor(Qt.transparent)  # 透明背景
